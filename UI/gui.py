...
"")
        ...
        self.horizontalLayout_7.addWidget(self.labelPlayerNumber)
        ...
        self.horizontalLayout_7.addWidget(self.lcdNumberPlayer)
...
" }")
        ...
        self.labelOddsFlopP = QtWidgets.QLabel(self.groupBoxOdds)
        self.labelOddsFlopP.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.labelOddsFlopP.setObjectName("labelOddsFlopP")
        self.gridLayout_3.addWidget(self.labelOddsFlopP, 0, 3, 1, 1)
        self.labelOddsTurnP = QtWidgets.QLabel(self.groupBoxOdds)
        self.labelOddsTurnP.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.labelOddsTurnP.setObjectName("labelOddsTurnP")
        self.gridLayout_3.addWidget(self.labelOddsTurnP, 1, 3, 1, 1)
        self.labelOddsRiverP = QtWidgets.QLabel(self.groupBoxOdds)
        self.labelOddsRiverP.setMinimumSize(QtCore.QSize(30, 0))
        self.labelOddsRiverP.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.labelOddsRiverP.setObjectName("labelOddsRiverP")
        self.gridLayout_3.addWidget(self.labelOddsRiverP, 2, 3, 1, 1)
        ...
        self.labelPosX = QtWidgets.QLabel(self.ConfigTab)
        self.labelPosX.setObjectName("labelPosX")
        self.horizontalLayout_2.addWidget(self.labelPosX)
        self.spinBoxPosX = QtWidgets.QSpinBox(self.ConfigTab)
        self.spinBoxPosX.setMaximum(1000)
        self.spinBoxPosX.setObjectName("spinBoxPosX")
        self.horizontalLayout_2.addWidget(self.spinBoxPosX)
        self.labelPosY = QtWidgets.QLabel(self.ConfigTab)
        self.labelPosY.setObjectName("labelPosY")
        self.horizontalLayout_2.addWidget(self.labelPosY)
        self.spinBoxPosY = QtWidgets.QSpinBox(self.ConfigTab)
        self.spinBoxPosY.setMaximum(1000)
        self.spinBoxPosY.setObjectName("spinBoxPosY")
        self.horizontalLayout_2.addWidget(self.spinBoxPosY)
        self.horizontalLayout_6.addLayout(self.horizontalLayout_2)
        self.gridLayout.addLayout(self.horizontalLayout_6, 2, 1, 1, 1)
        self.labelScreenPos = QtWidgets.QLabel(self.ConfigTab)
        self.labelScreenPos.setObjectName("labelScreenPos")
        self.gridLayout.addWidget(self.labelScreenPos, 2, 0, 1, 1)
        self.labelFrameSize = QtWidgets.QLabel(self.ConfigTab)
        self.labelFrameSize.setObjectName("labelFrameSize")
        self.gridLayout.addWidget(self.labelFrameSize, 3, 0, 1, 1)
        self.horizontalLayout_3 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_3.setObjectName("horizontalLayout_3")
        self.labelSizeX = QtWidgets.QLabel(self.ConfigTab)
        self.labelSizeX.setObjectName("labelSizeX")
        self.horizontalLayout_3.addWidget(self.labelSizeX)
        self.spinBoxSizeX = QtWidgets.QSpinBox(self.ConfigTab)
        self.spinBoxSizeX.setMaximum(500)
        self.spinBoxSizeX.setObjectName("spinBoxSizeX")
        self.horizontalLayout_3.addWidget(self.spinBoxSizeX)
        self.labelSizeY = QtWidgets.QLabel(self.ConfigTab)
        self.labelSizeY.setObjectName("labelSizeY")
        self.horizontalLayout_3.addWidget(self.labelSizeY)
        self.spinBoxSizeY = QtWidgets.QSpinBox(self.ConfigTab)
        self.spinBoxSizeY.setMaximum(1000)
        self.spinBoxSizeY.setObjectName("spinBoxSizeY")
        self.horizontalLayout_3.addWidget(self.spinBoxSizeY)
        self.gridLayout.addLayout(self.horizontalLayout_3, 3, 1, 1, 1)
        self.labelConfigGen = QtWidgets.QLabel(self.ConfigTab)
        self.labelConfigGen.setObjectName("labelConfigGen")
        self.gridLayout.addWidget(self.labelConfigGen, 1, 0, 1, 1)
        ...
        self.labelTimeOut = QtWidgets.QLabel(self.ConfigTab)
        self.labelTimeOut.setMaximumSize(QtCore.QSize(50, 16777215))
        self.labelTimeOut.setObjectName("labelTimeOut")
        self.horizontalLayout_4.addWidget(self.labelTimeOut)
        self.spinBoxTimeOut = QtWidgets.QSpinBox(self.ConfigTab)
        self.spinBoxTimeOut.setMaximumSize(QtCore.QSize(80, 16777215))
        self.spinBoxTimeOut.setMinimum(1)
        self.spinBoxTimeOut.setMaximum(60)
        self.spinBoxTimeOut.setProperty("value", 5)
        self.spinBoxTimeOut.setObjectName("spinBoxTimeOut")
        self.horizontalLayout_4.addWidget(self.spinBoxTimeOut)
        ...
        self.listWidgetHistory = QtWidgets.QListWidget(self.tab)
        self.listWidgetHistory.setObjectName("listWidgetHistory")
        self.gridLayout_5.addWidget(self.listWidgetHistory, 0, 0, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.labelOddsFlopP.setText(_translate("MainWindow", "0%"))
        self.labelOddsTurnP.setText(_translate("MainWindow", "0%"))
        self.labelOddsRiverP.setText(_translate("MainWindow", "0%"))
        ...
        self.labelPosX.setText(_translate("MainWindow", "Position X:"))
        self.labelPosY.setText(_translate("MainWindow", "Position Y:"))
        self.labelScreenPos.setText(_translate("MainWindow", "Screen Pos:"))
        self.labelFrameSize.setText(_translate("MainWindow", "Frame Size:"))
        self.labelSizeX.setText(_translate("MainWindow", "Size X:"))
        self.labelSizeY.setText(_translate("MainWindow", "Size Y:"))
        self.labelConfigGen.setText(_translate("MainWindow", "Generation"))
